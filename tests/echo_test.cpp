...
// Test basic input such ass "echo "Hello world!"
TEST(EchoTestGroup, BasicTest)
{
	
}

// Test input with option -n
TEST(EchoTestGroup, OptionsTest)
{
	
}

// Test input with wildcard variable $
TEST(EchoTestGroup, WildCardTest)
{
